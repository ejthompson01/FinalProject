...
When all customizations are selected and entered, hit "Generate Pattern." A link to trigger the download will appear to the right of the button. If you have forgotten to select or enter one of the required inputs, the link will not appear. You will find your sweater pattern in the patterns folder called (the entered name)_sweater_pattern.pdf.